...
export default function LoginPage({ searchParams }: { searchParams: Promise<Record<string, string>> }) {
    ...
    <main className={`min-h-screen flex items-center justify-center px-4 transition-colors ${isDark ? "bg-dark-950" : "bg-gray-50"}`}>
      <div className="w-full max-w-md">
        ...
        <div className={`rounded-2xl p-8 shadow-elevated border transition-colors ${isDark ? "bg-dark-800 border-dark-700" : "bg-white border-gray-100"}`}>
          ...
          <button className={`w-full flex items-center justify-center gap-3 border font-medium py-3 rounded-xl transition-all text-sm ${isDark ? "bg-dark-700 border-dark-600 text-gray-300 hover:bg-dark-600" : "bg-white border-gray-200 text-gray-700 hover:bg-gray-50"}`}>
